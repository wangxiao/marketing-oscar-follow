function simpleAnimation( options ) {
	...
	********************************************/
	G_options.onstart();
	G_loadImagesList = SA.loadImage( G_options.imagesList, G_options.onready );
